...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' Im Diad',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`,' Sad ','Im hate you'];
    var i = -1;
    var j = 0;
...
client.login(NjU3OTE3NTE1NzQ5NjU0NTI4.Xf4s_g.zbzQQzo47eFVa0GPx2elySTmDP4);
